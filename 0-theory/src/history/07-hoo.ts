import { interval, map, mergeAll, mergeMap, of, switchMap } from 'rxjs';
// import '../../assets/css/style.css';
// import { terminalLog } from '../../utils/log-in-terminal';

// const stream$ = interval(1000).pipe(
//     // map(value => of(value)), // Observable<Obsebvable<number>>
//     // mergeAll(), // Obsebvable<number>
//     mergeMap(value => of(value)), // map(cb) + ...All() === ...Map(cb)
// );
...
//     switchMap(parentValue => interval(2000).pipe(
//         map(childValue => `Parent: ${parentValue} / Child: ${childValue}`)
//     )),
// );

// resultStream$.subscribe(value => {
//     terminalLog(value);
// });
